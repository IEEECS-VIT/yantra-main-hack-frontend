...
export default function TeamMemberCard({
  ...
  return (
    <div className="p-5 border border-white bg-white w-56 h-64 md:w-72 md:h-80 backdrop-blur-md bg-opacity-20 relative flex items-center flex-col justify-center">
