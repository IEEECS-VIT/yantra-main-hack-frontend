...
import { FaInstagram, FaTwitter, FaYoutube, FaFacebook,FaLinkedin } from 'react-icons/fa'; // Import social media icons
...
const FooterCard = () => {
  ...
  return (
    <>
      <footer className="relative p-8 bg-transparent rounded-xl bottom-0">
        ...
        <div className="relative max-w-6xl mx-auto md:grid flex flex-col-reverse md:grid-cols-3 gap-8 text-white">
          <div className="space-y-4 md:text-left text-center">
            <h1 className="text-xl md:text-5xl">YANTRA <span className="block">HACK</span></h1>
            <div className="space-y-2">
              <h2 className="text-lg md:text-xl italic">Made with <Heart className="inline text-white" /> by</h2>
              <p className="text-2xl md:text-5xl">IEEE-CS</p>
              <p className="text-xs md:text-sm mt-4">© {currentYear}, All rights reserved</p>
            </div>
          </div>
          ...
          <div className="relative overflow-hidden rounded-xl border border-white/20">
            ...
            <div className="relative space-y-8 p-8">
              <h2 className="md:text-2xl text-xl font-semibold text-[#557cff]">LINKS</h2>
          ...
          <div className="relative overflow-hidden rounded-xl border border-white/20">
            <div className="absolute inset-0 bg-white/10 backdrop-blur-sm" />
            <div className="relative space-y-8 p-8">
              <h2 className="md:text-2xl text-xl font-semibold text-[#557cff]">CONTACT US</h2>
      ...
      <Image src={ieeeLogo} alt="VIT" width={200} height={200} className="md:w-48 w-24" />
        <Image src={vitLogo} alt="VIT" width={200} height={200} className="md:w-48 w-24" />
        <Image src={yantraLogo} alt="Yantra" width={200} height={200} className="md:w-48 w-24" />
      </div>
    </>
  );
};
