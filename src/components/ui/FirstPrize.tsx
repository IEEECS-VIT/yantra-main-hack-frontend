export default function FirstPrize() {
    return (
      <div className="p-5 border border-black bg-slate-200 w-64 min-h-64 md:w-full md:min-h-64 backdrop-blur-md bg-opacity-20 relative flex items-center flex-col justify-center">
